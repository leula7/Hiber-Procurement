...
const Branch = () => {
    ...
    const [InsertBranch] = useInsertEmployeeMutation();
    ...
    const handleInsertBranch = async (values, onSubmitProps) => {
        try {
          console.log(values)
         
          const result = await InsertBranch(values);
  ...
  return (
    ...
    handleFormSubmit={handleInsertBranch}
    />
  </Box>
  </Box>
  )
